      ...
      <div className={styles.profileDetailContainer}>
        ...
        <section className={styles.profileSection}>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>{t('profile.ourName.title')}</h2>
          </div>
        ...
        <section className={styles.profileSection}>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>{t('profile.mission.title')}</h2>
          </div>
          <div className={styles.sectionContent}>
        ...
        <section className={styles.profileSection}>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>{t('profile.features.title')}</h2>
          </div>
          <div className={styles.sectionContent}>
            <div className={styles.featureItem}>
              <h3 className={styles.featureTitle}>{t('profile.features.safety.title')}</h3>
              <p>{t('profile.features.safety.description')}</p>
            </div>
            <div className={styles.featureItem}>
              <h3 className={styles.featureTitle}>{t('profile.features.etiquette.title')}</h3>
              <p>{t('profile.features.etiquette.description')}</p>
            </div>
            <div className={styles.featureItem}>
              <h3 className={styles.featureTitle}>{t('profile.features.professional.title')}</h3>
              <p>{t('profile.features.professional.description')}</p>
            </div>
            <div className={styles.featureItem}>
              <h3 className={styles.featureTitle}>{t('profile.features.matching.title')}</h3>
              <p>{t('profile.features.matching.description')}</p>
            </div>
            <div className={styles.featureItem}>
              <h3 className={styles.featureTitle}>{t('profile.features.community.title')}</h3>
        ...
        <section className={styles.profileSection}>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>{t('profile.values.title')}</h2>
          </div>
          <div className={styles.sectionContent}>
            <div className={styles.valuesGrid}>
              <div className={styles.valueItem}>
                <h3 className={styles.valueTitle}>{t('profile.values.sincerity.title')}</h3>
                <p>{t('profile.values.sincerity.description')}</p>
              </div>
              <div className={styles.valueItem}>
                <h3 className={styles.valueTitle}>{t('profile.values.openness.title')}</h3>
                <p>{t('profile.values.openness.description')}</p>
              </div>
              <div className={styles.valueItem}>
                <h3 className={styles.valueTitle}>{t('profile.values.respect.title')}</h3>
                <p>{t('profile.values.respect.description')}</p>
              </div>
              <div className={styles.valueItem}>
                <h3 className={styles.valueTitle}>{t('profile.values.growth.title')}</h3>
                <p>{t('profile.values.growth.description')}</p>
              </div>
              <div className={styles.valueItem}>
                <h3 className={styles.valueTitle}>{t('profile.values.connection.title')}</h3>
        ...
        <section className={styles.profileSection}>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>{t('profile.joinUs.title')}</h2>
          </div>
          <div className={styles.sectionContent}>
